...
class Booking
{
     ...
     * @Assert\Date(
     * message="Attention la date d'arrivée doit être au bon format"
     * )
     ...
     * @ORM\Column(type="datetime")
    * @Assert\Date(
     * message="Attention la date de fin doit être au bon format"
     * )
    ...
    */
    ...
    public function isBookableDates(){
        ...
        // 2/ Il faut comparer les dates choisies avec les autres dates
